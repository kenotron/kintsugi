...
/**
 * All Package Cache: { package name: package absolute path } 
 */
var allPackages;
/**
...
function getAllPackages(packageBasePath) {
	...
	var packageJsonPaths = glob.sync(path.join(packageBasePath, "**", "package.json"));
	allPackages = {};
...
module.exports.collectPackages = function collectPackages(packageBasePath, packageNames, depth) {
	depth = depth || 0;
	var allPackages = getAllPackages(packageBasePath);
